...
class PreferenceArticle(_message.Message):
    __slots__ = ("url", "title", "summary", "similarity", "published_on")
    URL_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, url: _Optional[str] = ..., title: _Optional[str] = ..., summary: _Optional[str] = ..., similarity: _Optional[float] = ..., published_on: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
